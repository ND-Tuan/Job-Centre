...
<div class="form">
    <div class="form-fill">
        <div class="form-all">
            <h2>Tin tuyển dụng có dấu hiệu lừa đảo</h2>
        </div>
    </div>
</div>
<section>
                    ...
                    <div class="myRecruitment">
                        ...
                        <div style=" display: flex; justify-content: space-between; width:100%; align-items: center;">
                            ...
                            <div>
                                ...
                                <a class="btn-apply" 
                                onclick=" return confirm('Bạn có chắc muốn đưa báo cáo này vào diện đã xử lý ?');" 
                                style="min-width: 80px; font-weight: 700;"
                                href="<?php echo $actual_link ?>/admin/report_delete/<?php echo $jobs['ID'] ?>">Đã xử lý</a>
                            </div>
                        </div>
                    </div>
                </div>
