    ...
    <div class="container" style="top: 4.5cm;">
        <div class="forms">
            <div class="form login">
                <span class="title">Người tuyển dụng đăng nhập</span> </br>
                
                <form id="submit-login" method="post" action="<?php echo $actual_link ?>/employer/login_processing">
                    <?php
                ...
                <div class="login-signup">
                    <span class="text">Chưa có tài khoản?
                        <a href="<?php echo $actual_link ?>/employer/register" class="text signup-link">Đăng kí ngay</a>
                    </span>
                </div>
            </div>
        </div>
    </div>
    <span class="text1">Bạn là người tìm việc ?
        <a href="<?php echo $actual_link ?>/customer/login" class="text2">Đăng nhập</a>
    </span>
</div>
