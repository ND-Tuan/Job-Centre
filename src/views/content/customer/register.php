    ...
    <div class="container active">
        <div class="forms">
            ...
            <div class="form signup">
                <span class="title">Người tìm việc đăng ký</span>

                <form name ="register-submit" id="register-submit" method="post" action="<?php echo $actual_link ?>/customer/register_processing">
                    <?php
                    ...
                    <div class="checkbox-text">
                        <div class="checkbox-content">
                            ...
                            <label for="sigCheck" class="text">
                                Bạn đồng ý với
                                <a style="color: red" target="blank" href="<?php echo $actual_link ?>/home/TermsOfService"> Điều khoản sử dụng</a>
                            </label>
                        </div>
                    </div>
                ...
                <div class="login-signup">
                    <span class="text">Đã có tài khoản?
                        <a href="<?php echo $actual_link ?>/customer/login" class="text login-link">Đăng nhập</a>
                    </span>
                </div>
            </div>
        </div>
